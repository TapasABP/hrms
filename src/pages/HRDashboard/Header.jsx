...
const Header = () => {
  return (
    ...
    <div className="flex items-center gap-4">
      ...
      <h1 className="text-xl font-semibold tracking-wide">HR Dashboard</h1>
    </div>
    <div className="text-sm flex items-center gap-2">
      <span id="employeeName">Welcome</span>
      <span className="text-red-300 hover:text-red-100 underline cursor-pointer" >Logout</span>
    </div>
  </header>
  )
}
